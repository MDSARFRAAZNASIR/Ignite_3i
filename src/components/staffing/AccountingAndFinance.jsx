...
const whyChooseCards = [
  {
    ...
    desc: "Benefit from our extensive network of professionals with specialized expertise in Accounting & Finance, ensuring a perfect match for your specific needs.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Tailored IT Staffing Solutions:",
    desc: "Tailored staffing solutions means that your Accounting & Finance team is staffed with individuals who understand the unique requirements of your business.",
    icon: Lightbulb,
  },
  {
  ...
  },
  {
    ...
    desc: "Beyond transactional staffing we aim to be your strategic partner with a goal to help you build a dynamic and efficient Accounting & Finance team.",
    icon: Zap,
  },
  {
      ...
      <section className="relative min-h-screen  pt-25 h-[88vh] w-full overflow-hidden flex items-center">
        ...
        Accounting & Finance Staffing
            ...
            <motion.p
              ...
              className="text-[20px] lg:text-[28px] text-white font-extralight tracking-wide mb-2 py-2"
            >
Expertise, Efficiency and Strategic Partnerships
            </motion.p>
...
Welcome to Ignite<span className="text-red-500">3i</span>, where excellence meets precision in Accounting & Finance staffing solutions. In the dynamic landscape of financial operations, businesses require a partner who understands the critical role played by Accounting & Finance teams.
              </h2>
            </div>
          </motion.div>
