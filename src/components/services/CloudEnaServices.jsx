...
const serviceCards = [
  ...
  {
    title: "Multi-Cloud Architecture Guidance",
    desc: "Navigating through different cloud providers and their array of services can be daunting. Netpace simplifies this complexity by guiding you through available options, assisting in selecting features and services tailored to your needs for a straightforward and manageable cloud solution.",
    icon: Eye,
  },
  {
    title: "Robust Backup and Disaster Recovery Solutions",
    desc: "Recognizing the significance of data in today’s data-driven age, we build robust disaster recovery infrastructure, ensuring uninterrupted business continuity by securely backing up critical information.",
    icon: ScanSearch,
  },
  {
    title: "Cost Optimization Advisory",
    desc: "Understanding and optimizing pricing schemes across cloud providers can be overwhelming. Netpace’s advisory services assist in selecting cost-effective models tailored to your business needs, ensuring maximum benefits at the lowest price point without compromising quality or accessibility.",
    icon: Speech,
  },
];
...
const whyChooseCards = [
  {
    title: "Expert Team",
    desc: "With a team of over 250 experts specializing in cloud enablement for various industries, including fintech, logistics, retail, insurance, and healthcare, Netpace delivers comprehensive solutions tailored to specific business requirements.",
    icon: BriefcaseBusiness,
  },
  {
    title: "Innovation-driven Approach",
    desc: "Staying abreast of the latest IT trends and leveraging cutting-edge technologies, Netpace ensures innovative, future-ready solutions for clients.",
    icon: Lightbulb,
  },
  {
  ...
  },
  {
    ...
    desc: "We prioritize data security, deploying specialized tools and mechanisms compliant with industry regulations to safeguard clients’ sensitive information.",
    icon: Zap,
  },
      ...
      <section className="relative min-h-screen  pt-25 h-[88vh] w-full overflow-hidden flex items-center">
        ...
        <div className="relative z-20 max-w-7xl mx-auto w-full px-8 lg:px-16">
          ...
          >
            ...
            >
              Navigating Cloud Adoption and Modernization Services
            </motion.p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0b1733] via-[#0d1b38] to-[#111827] text-white">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-8 lg:px-16 py-24">
            ...
            >
              <p className="text-center text-[28px] lg:text-[22px] leading-[1.8] font-light  text-slate-100">
                ...
                computing resources, democratizing enterprise-grade services for
                individuals and small-scale businesses alike.
              </p>
              <p className="text-center text-[18px] lg:text-[22px] leading-[1.8] font-light text-slate-100">
                ...
                cloud computing not only optimizes IT infrastructure costs but
                also empowers seamless accessibility to critical data and
                business applications from anywhere with an internet connection.
              </p>
              <motion.div
          ...
          <div className="grid lg:grid-cols-3 gap-20">
            ...
            >
              <h2 className="text-[25px] lg:text-[45px] leading-[1.05] font-sans text-white">
                Why Choose
                <br />
                Ignite<span className="text-red-600">3i</span>?
              </h2>
            </motion.div>
